...
namespace Klak.Spout
{
    internal static class Plugin
    {
        ...
        public static extern void GetSenderNames
            ([Out] [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] out IntPtr[] names, out int count);
    ...
    internal static class ReceiverDataExtension
    {
        public static DxgiFormat GetDxgiFormat(this Plugin.ReceiverData data)
        {
            return (DxgiFormat)data.dxgiFormat;
        }

        public static TextureFormat GetTextureFormat(this Plugin.ReceiverData data)
        {
